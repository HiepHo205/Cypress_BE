...
<template>
    <div class="relative rounded-2xl">
        <LoadingOverlay :show="pageLoading" message="Loading favicon..." :fullScreen="false" />
        ...
        <div :class="pageLoading ? 'pointer-events-none opacity-50' : ''">
            ...
            <div class="mt-8 flex justify-end">
                ...
                <button :disabled="saving" @click="save"
                    class="rounded-xl bg-blue-600 px-6 py-2.5 text-sm font-medium text-white transition hover:bg-blue-700 disabled:opacity-50">
