    ...
    <div class="min-h-screen bg-gray-50 p-6">
        <div class="mb-6 flex items-center justify-between rounded-2xl bg-white p-6 shadow-sm">
            <div>
                ...
                <p class="mt-2 text-sm text-gray-500">
                    Configure all header settings, including logo, favicon, navigation menu, and countdown.
                </p>
            </div>
        ...
        <div class="grid grid-cols-12 gap-6">
            ...
            <div class="col-span-9 rounded-2xl bg-white p-6 shadow-sm">
                <LogoSection v-if="activeTab === 1" />

                <FaviconSection v-else-if="activeTab === 2" />

                <MenuSection v-else-if="activeTab === 3" />

                <CountdownSection v-else-if="activeTab === 4" />
            </div>
        </div>
    </div>
</template>
